...
class GoogleSearcher:
    def __init__(self, upload="upload",
       ...
       # 用户自己的firefox 数据页
       # 自定义可以参考 https://blog.csdn.net/weixin_44676081/article/details/106322068
        profile = FirefoxProfile(
            f'C:/Users/{USERNAME}/AppData/Roaming/Mozilla/Firefox/Profiles/8qrydh7k.default-release-1')
        # 使用firefox，如果没有使用镜像，需要添加profile
        # 使用 镜像的时候可能需要更改一些class属性才能查找到对应的html元素
